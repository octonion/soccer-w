...
rpl -e '\t-\t' '\t\t' /tmp/rosters.csv
psql soccer-w -f loaders/load_rosters.sql
rm /tmp/rosters.csv
...
rpl -q ' ' '' /tmp/player_summaries.csv
psql soccer-w -f loaders/load_player_summaries.sql
...
rpl -q ' ' '' /tmp/team_summaries.csv
psql soccer-w -f loaders/load_team_summaries.sql
rm /tmp/team_summaries.csv

# Remove commas from some columns, convert to integer

#psql soccer-w -f cleaning/commas_psp.sql
#psql soccer-w -f cleaning/commas_tsh.sql
#psql soccer-w -f cleaning/commas_tsp.sql
#psql soccer-w -f cleaning/commas_tsf.sql
...
rpl "[" "{" /tmp/periods.csv
rpl "]" "}" /tmp/periods.csv
psql soccer-w -f loaders/load_periods.sql
rm /tmp/periods.csv
...
#psql soccer-w -f cleaning/deduplicate_periods.sql
#psql soccer-w -f cleaning/deduplicate_pbp.sql
#psql soccer-w -f cleaning/deduplicate_bsh.sql
#psql soccer-w -f cleaning/deduplicate_bsp.sql
#psql soccer-w -f cleaning/deduplicate_bsf.sql

# Add primary keys and constraints

#psql soccer-w -f cleaning/add_pk_periods.sql
#psql soccer-w -f cleaning/add_pk_pbp.sql
#psql soccer-w -f cleaning/add_pk_bsh.sql
#psql soccer-w -f cleaning/add_pk_bsp.sql
#psql soccer-w -f cleaning/add_pk_bsf.sql
